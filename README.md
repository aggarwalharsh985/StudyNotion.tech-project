# StudyNotion Online Education Platform (MERN App) [Website Link](https://study-notion-frontend-beige-psi.vercel.app/)
##  Building StudyNotion: An EdTech Platform Powered by the MERN Stack 
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/aggarwalharsh985/StudyNotion.tech-project.git
   ```
