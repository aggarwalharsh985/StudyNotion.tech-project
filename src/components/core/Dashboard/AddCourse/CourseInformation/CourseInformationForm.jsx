...
import RequirementsField from "./RequirementsFieds"
        ...
        >
            ...
            <div className="flex flex-col space-y-2">
                ...
                {errors.courseShortDesc && (
                    <span lassName="ml-2 text-xs tracking-wide text-pink-200">
            ...
            <div className="flex flex-col space-y-2">
                <label className="text-sm text-richblack-5" htmlFor="courseBenefits">
                    Benifits of the Course <span className="text-pink-200">*</span>
                </label>
                <textarea
                    id="courseBenefits"
